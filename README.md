...
7. Базовые функции системы управления требованиями
...
Для сужения результатов анализа, ведены классы архитектурных решений: Первый тип это Model-View-Controller pattern.
